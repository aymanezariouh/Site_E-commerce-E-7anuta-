                ...
                <div class="relative">
                    <button class="p-2 rounded-full hover:bg-gray-100 relative transition-colors group" 
                        ...
                        <svg class="w-6 h-6 text-gray-600 group-hover:text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-3.405-3.405A1.005 1.005 0 0118 14V11a6.003 6.003 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3c0 .297-.132.578-.368.770L2 18h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                        </svg>
